...
# ----------------- App Title -----------------
st.title("Chatbot with phone session + KB")
...
if "kb_uploaded" not in st.session_state:
...
if not st.session_state.session_active:
    ...
    if st.button("Start Chat"):
        ...
        try:
            ...
            # Wait for backend confirmation of phone
...
# ----------------- Step 3: Chat -----------------
if st.session_state.session_active and st.session_state.kb_uploaded:
